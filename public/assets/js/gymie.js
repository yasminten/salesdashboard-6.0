var gymie = (function ($) {
	...
	return {
		...
		customerdetails: function () {
			$("#broadbanddetails").hide();


			$('#customer_type').on('change', function () {
				if (this.value == '0') { //Broadband
					$("#broadbanddetails").show();
		...
		/* NPWP Details
		/* --------------------------------- */
		npwpdetails: function () {

			$("#npwpdetails").hide();

			$('#npwp_status').on('change', function () {
				if (this.value == '0') {
					$("#npwpdetails").hide();
				}
				else {
